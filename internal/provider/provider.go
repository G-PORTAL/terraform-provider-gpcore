...
var _ provider.Provider = &GPCoreProvider{}

// GPCoreProvider defines the provider implementation.
type GPCoreProvider struct {
...
// GPCoreProviderModel describes the provider data model.
type GPCoreProviderModel struct {
...
func (p *GPCoreProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "gpcore"
	resp.Version = p.version
}

func (p *GPCoreProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *GPCoreProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	var data GPCoreProviderModel
...
func (p *GPCoreProvider) Resources(ctx context.Context) []func() resource.Resource {
...
func (p *GPCoreProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
